...
A simple bash script that uses [Newsboat](https://newsboat.org/), [Pandoc](https://pandoc.org), and [Mutt](http://www.mutt.org/) to read the contents of a [SQLite](https://sqlite.org) database generated by newsboat, convert each unread news item to plain text using pandoc and then sent it as an email message to a given user using mutt.
